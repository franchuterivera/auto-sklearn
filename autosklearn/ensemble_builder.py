...
class EnsembleBuilder(object):
    ...
    def fit_ensemble(self, selected_keys: list):
        ...
        ensemble = EnsembleSelection(
            ...
            ) if self.bbc_cv_strategy in [ 'autosklearnBBCScoreEnsemble', 'autosklearnBBCScoreEnsembleMAX', 'autosklearnBBCScoreEnsembleMAXWinner', 'autosklearnBBCScoreEnsembleAVGMDEV'] else None,
